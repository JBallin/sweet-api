...
const {
  ...
  validateCurrPwd, validateGistIdIfExists,
...
router.put('/:id', validateId, validateCurrPwd, validateJWT, validateUserUpdate, validateGistIdIfExists, ctrl.updateUser);
router.delete('/:id', validateId, validateCurrPwd, validateJWT, ctrl.deleteUser);
